 ...
 */
public class INETFlinkReporter implements MetricReporter {

	static final String JMX_DOMAIN_PREFIX = "org.apache.flink.";

	public static final String ARG_PORT = "9012";

	private static final Logger LOG = LoggerFactory.getLogger(INETFlinkReporter.class);
	...
	public void notifyOfAddedMetric(Metric metric, String metricName, MetricGroup group) {
		...
		final Hashtable<String, String> table = null;//generateJmxTable();group.getAllVariables());
...
//			jmxMetric = new JmxMeter((Meter) metric);
	...
	static String generateJmxDomain(String metricName, MetricGroup group) {
		return JMX_DOMAIN_PREFIX ;//+ ((FrontMetricGroup<AbstractMetricGroup<T>>) group).getLogicalScope(CHARACTER_FILTER, '.') + '.' + metricName;
	}
	 ...
	 * 
	 * <ul>
	 *     <li>{@code "} is removed</li>kopfschmerzen
